      ...
      <div className="relative mt-8 md:mt-14">
        ...
        <div className="relative will-change-transform">
          <motion.h1
            ...
            className="display-hero text-spice text-[26vw] md:text-[22vw] leading-[0.85] whitespace-nowrap pl-[3vw] will-change-transform"
          >
            Začin
          </motion.h1>
        </div>
        ...
        <div className="relative -mt-[6vw] md:-mt-[5vw] flex items-center justify-center">
          <motion.div
            initial={{ y: "0%", scale: 1 }}
            whileInView={{ y: "30%", scale: 1.15 }}
            viewport={{ once: false, margin: "-40%" }}
            transition={{ duration: 1.5, ease: [0.22, 1, 0.36, 1] }}
            className="relative w-[78vw] md:w-[42vw] aspect-[3/4] overflow-hidden shadow-[0_30px_60px_-20px_rgba(31,27,22,0.35)] will-change-transform"
          >
            <img
        ...
        <div className="relative -mt-[6vw] md:-mt-[5vw]">
          <motion.h1
            ...
            viewport={{ once: false, margin: "-40%" }}
            transition={{ duration: 1.5, ease: [0.22, 1, 0.36, 1] }}
            className="display-hero text-ink text-[12vw] md:text-[18vw] leading-[0.85] whitespace-nowrap pl-[3vw] will-change-transform"
          >
            Sarajevo
          </motion.h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-end">
          ...
          <Reveal className="md:col-span-5" delay={0.15}>
            <div className="flex items-start gap-4">
              <span className="font-heading text-spice text-5xl leading-none font-extrabold">✦</span>
              <div>
